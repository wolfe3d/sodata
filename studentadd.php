...
$query = "INSERT INTO `student` (`first`,`last`,`schoolID`,`studentschoolID`,`scilympiadID`,`yearGraduating`,`email`,`emailSchool`,`phoneType`,`phone`,`parent1Last`,`parent1First`,`parent1Phone`,`parent1Email`,`parent2Last`,`parent2First`,`parent2Phone`,`parent2Email`,`uniqueToken`) VALUES ('$first', '$last', '".$_SESSION['userData']['schoolID']."', `studentschoolID`, '$scilympiadID', '$yearGraduating', '$email', '$emailSchool', '$phoneType', '$phone', '$parent1Last', '$parent1First', '$parent1Phone', '$parent1Email', '$parent2Last', '$parent2First', '$parent2Phone', '$parent2Email', 1)";
